...
|---------|-----------|-----------------|------|
| 钉住/取消 | 3.06 ns | 5.37 ns | **快 1.75 倍** |
...
|-------|-----------|-----------------|------|
| 2 线程 | 76.46 µs | 80.65 µs | **快 1.05 倍** |
| 4 线程 | 132.84 µs | 140.43 µs | **快 1.06 倍** |
| 8 线程 | 240.94 µs | 254.87 µs | **快 1.06 倍** |
| 16 线程 | 451.65 µs | 477.67 µs | **快 1.06 倍** |
...
|-----|-----------|-----------------|------|
| 回收 100 项 | 3.10 µs | 0.92 µs | **慢 3.37 倍** |
| 回收 1,000 项 | 27.62 µs | 14.44 µs | **慢 1.91 倍** |
| 回收 10,000 项 | 273.98 µs | 168.27 µs | **慢 1.63 倍** |
...
| 基准测试 | SWMR-Epoch | Crossbeam-Epoch | 优势 |
|---------|-----------|-----------------|------|
| 加载 | 3.07 ns | 333.98 ns | **快 108.8 倍** |
...
|-------|-----------|-----------------|--------|
| 2 线程 | 85.19 µs | 615.00 µs | **快 7.22 倍** |
| 4 线程 | 146.80 µs | 1,334.9 ms | **快 9.09 倍** |
| 8 线程 | 254.39 µs | 3,379.1 ms | **快 13.28 倍** |
